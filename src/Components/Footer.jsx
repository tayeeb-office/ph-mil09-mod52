...
const Footer = () => {
    return (
        <div className='md:w-6xl mx-auto' >
                     ...
                     <footer className=" bg-[#101622] text-white  md:flex md:justify-between md:items-center">
                        
                        <div><img className='ml-[40px] md:md-[0px] w-[100px] h-[80px] md:w-[200px] md:h-[150px]' src={logo} alt="Logo" /></div>
                        ...
                        <nav className=' w-[160px] flex flex-col gap-[20x]'>
                            ...
                            <a className="link link-hover mt-[12px]">All Games</a>
                    ...
                    <footer className="footer sm:footer-horizontal footer-center  bg-[#101622] text-white ">
                        <aside>
