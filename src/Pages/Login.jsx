      ...
      <section className=" w-full flex items-center justify-center px-4 py-30">
        <div className="w-full max-w-md rounded-2xl bg-[#1A1E24]/90 shadow-2xl ring-1 ring-white/10 px-6 py-10">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-slate-400">Log in to your Gamehub account</p>
          </div>
          ...
          <form className="mt-8 space-y-5">
           ...
           {/* Email */}
            ...
            {/* Reset Pass */}
            <p className="mt-6 text-sm text-slate-400">Forgot Passoward? 
            <Link to="/reset"><span className="text-blue-500 hover:text-blue-400 cursor-pointer font-semibold"> Click Here</span></Link>
            </p>
          ...
          <p className="mt-6 text-center text-sm text-slate-400">Don’t have an account? 
            <Link to="/registration"><span className="text-blue-500 hover:text-blue-400 cursor-pointer font-semibold"> Sign Up</span></Link>
          </p>
